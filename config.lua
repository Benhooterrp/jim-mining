...
Config = {
	...
	Locations =  {
		['MineStore'] = {
			...
			{ name = "Quarry", coords = vector4(2960.9, 2754.14, 43.71, 204.58), sprite = 527, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
		...
		['Smelter'] = {	 -- The location of the smelter
			{ name = "Smelting Factory", coords = vector3(1112.73, -2008.88, 22.01), sprite = 436, col = 1, blipTrue = true, },
		},
		["Washing"] = {
		...
		['OreBuyer'] = { -- The Locations of the ore buyers
			{ name = "Ore Buyer", coords = vector4(-256.34, -986.41, 20.61, 185.15), sprite = 568, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
...
Crafting = {
	...
	NeckCut = {
		{ ["goldchain"] = { ["gold_bar"] = 3 }, ['amount'] = 2  },
		{ ["silverchain"] = { ["silveringot"] = 1 }, ['amount'] = 3  },
		{ ["diamond_necklace"] = { ["goldchain"] = 3, ["diamond"] = 1 }, },
